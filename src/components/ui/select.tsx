  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div className="relative">
        <select
          className={cn(
            "flex h-9 w-full appearance-none rounded-lg border border-border bg-white px-3 pr-8 py-1 text-[13px] text-foreground shadow-sm transition-all duration-200",
